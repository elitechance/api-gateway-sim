...
export class AppComponent implements  OnInit {
    ...
    private parseEditorById(id:number)  {
        switch (id) {
            case 1: this.parseEditor(id, this.editorHeaders); break;
            case 2: this.parseEditor(id, this.editorBody); break;
            case 3: this.parseEditor(id, this.editorStageVariables); break;
            case 4: this.parseEditor(id, this.editorContext); break;
            case 5: this.parseEditor(id, this.editorQueryParams); break;
            case 6: this.parseEditor(id, this.editorPathParams); break;
        }
    }
    ...
    private getTemplateById(id:number) {
        let templates = this.getBodyTemplates();
    ...
    private initEditorTemplate() {
        ...
        let value = this.getTemplateValueById(this.getBodyTemplates()[0].id);
    ...
    private initEditorOutput() {
        let options = Object['assign']({readOnly:true}, this.jsonOptions); // merge
    ...
    private getRequest() {
        let headers = JSON.parse(this.editorHeaders.getValue());
        let context = JSON.parse(this.editorContext.getValue());
        let stageVariables = JSON.parse(this.editorStageVariables.getValue());
        let queryParams = JSON.parse(this.editorQueryParams.getValue());
        let pathParams = JSON.parse(this.editorPathParams.getValue());
        let body = JSON.parse(this.editorBody.getValue());
        let template = this.editorTemplate.getValue();
        return {
            headers:headers,
            context:context,
