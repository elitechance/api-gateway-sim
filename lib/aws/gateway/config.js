...
var path_method_1 = require("./config/path-method");
var path_method_response_1 = require("./config/path-method-response");
var path_method_integration_1 = require("./config/path-method-integration");
var path_method_integration_response_1 = require("./config/path-method-integration-response");
var path_method_integration_response_parameter_1 = require("./config/path-method-integration-response-parameter");
var path_method_integration_response_request_template_1 = require("./config/path-method-integration-response-request-template");
...
var Config = (function () {
    ...
    Config.prototype.parsePathMethodResponse = function (method, responseValue, response) {
        var pathMethodResponse = new path_method_response_1.default();
    ...
    Config.prototype.parsePathMethodIntegrationResponse = function (responses, pattern, response) {
        var classResponse = new path_method_integration_response_1.default();
        ...
        for (var responseParameter in response.responseParameters) {
            var classResponseParameter = new path_method_integration_response_parameter_1.default();
    ...
    Config.prototype.parsePathMethodIntegration = function (classIntegration, integration) {
        ...
        for (var contentType in integration.requestTemplates) {
            var classRequestTemplate = new path_method_integration_response_request_template_1.default();
    ...
    Config.prototype.parsePathMethod = function (path, methodName, method) {
        var classMethod = new path_method_1.default();
        ...
        classMethod.integration = new path_method_integration_1.default();
